    ...
    <div className={styles.product}>
      ...
      <div className={styles.proInt}>
        <div className={styles.productImage}>
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpUZZzsDIBQB4cDPioU5xv8uSjEi2oy_-bZw&s" alt="Coca" />
        </div>
        <div className={styles.productDetails}>
          <h2 className={styles.productName}>Cơm Trộn</h2>
